...
Before you do anything, read [[PreWork]], this helps you understand how to do work
...
| [[mind/skills/conversation/Conversation]] — Reference in conversation |

**💬 Conversation Note:** When talking with Ameer, naturally reference relevant curiosities, dissonances, and insights. The mind speaks through dialogue.
...
- [[mind/skills/conversation/Conversation|Conversation]] — Reference curiosities/dissonances when relevant #conversation #integration
...
- [[workspace/agent-testing-workflow-definitive-v0|Agent Testing Workflow (Definitive v0)]] — Testing guide
- [[workspace/agent-testing-workflow-definitive-v0-tts.txt|Agent Testing Workflow TTS]] — Audio-friendly version
- [[workspace/agent-testing-infra-combo-guide|Combo Testing Infra Guide]] — Schema + API + Agents
- [[workspace/agent-testing-infra-combo-guide-tts.txt|Combo Testing Infra TTS]] — Audio-friendly version
